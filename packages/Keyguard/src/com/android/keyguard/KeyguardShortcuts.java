...
import com.android.internal.util.cpa.AppHelper;
import com.android.internal.util.cpa.ActionHelper;
import com.android.internal.util.cpa.ActionConfig;
import com.android.internal.util.cpa.Action;
...
public class KeyguardShortcuts extends LinearLayout {
    ...
    private void createShortcuts() {
        ...
        boolean longpress = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.CPA.LOCKSCREEN_SHORTCUTS_LONGPRESS, 1, UserHandle.USER_CURRENT) == 1;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.CPA.LOCKSCREEN_SHORTCUTS),
                    false, this, UserHandle.USER_ALL);
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.CPA.LOCKSCREEN_SHORTCUTS_LONGPRESS),
                    false, this, UserHandle.USER_ALL);
            update();
        }
